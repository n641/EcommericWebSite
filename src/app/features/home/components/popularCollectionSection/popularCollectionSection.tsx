...
function PopularCollectionSection({Products}:any) {
  return (
    <div>
      ...
      <div className="grid items-center gap-y-5 sm:gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-7 mt-10 self-center mx-auto">
