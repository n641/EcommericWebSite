    ...
    <ol className="flex w-full items-center">
      {Steps.map((item: any, index: number) => {
        ...
        return (
          <li
            key={index}
            className={`flex items-center text-[var(--fifth-Color)] ${
              index < 2 &&
              `w-full after:inline-block after:h-1 after:w-full after:border-4 after:border-b ${IsActive ? 'after:border-[var(--fifth-Color)]' : 'after:border-gray-100'} after:content-['']`
            }`}
          >
